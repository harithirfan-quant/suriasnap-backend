...
_SYSTEM = (
    ...
    "Useful facts (Malaysia): Solar ATAP is a net-billing scheme, NOT a feed-in tariff — surplus "
    "credits that same month's TNB bill at RM 0.27/kWh (≤1,500 kWh/month) or RM 0.37/kWh "
    "(>1,500 kWh/month, TNB territory only), capped at zeroing the bill. There is no cash payout "
    "beyond that, and unused surplus is not carried to the next month. Installed cost "
